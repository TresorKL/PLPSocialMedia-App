...
<body>
    ...
    <div class="container align-items-center ">
        ...
        @if (Session::get('post')->image != null)
            <div class="row">
                <div class="col-md-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <button type="button" class="btn btn-primary m-2" data-toggle="modal"
                                    ...
                                    Comment {{ Session::get('post')->comment()->count() }}
                                </button>
                                <form action="/like/{{ Session::get('post')->id }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-primary m-2">
                                        Like {{ Session::get('post')->likes }}
                                    </button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="card mb-4 ">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <button type="button" class="btn btn-primary m-2" data-toggle="modal"
                                    data-target="#commentModal">
                                    Comment {{ Session::get('comments')->count() }}
                                </button>
                                <form action="/like/{{ Session::get('post')->id }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-primary m-2">
        ...
        @foreach (Session::get('comments') as $comment)
            <div class="row">
                <div class="col-md-8 ">
                    <div class="card mb-4 ">
                        <p class="card-title text-primary">{{ $comment->commented_by }}</p>
        ...
        <div class="row">
            <div class="col-md-8 ">
                <div class="card mb-4 ">
                    <form action="/comment/{{ Session::get('post')->id }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="caption">Comment</label>
                            <textarea name="comment" type="text" class="form-control" id="caption" placeholder="Say something" required></textarea>
                        </div>
